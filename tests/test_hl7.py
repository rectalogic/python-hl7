...
class ParseTest(unittest.TestCase):
    ...
    def test_bytestring_converted_to_unicode(self):
        ...
        self.assertEqual(len(msg), 5)
        self.assertTrue(isinstance(msg[0][0][1], six.text_type))
        self.assertEqual(msg[0][0][1], 'MSH')
    ...
    def test_non_ascii_bytestring(self):
        ...
        self.assertEqual(msg[0][4][1], 'ELAB\u20133')
    ...
    def test_repetition(self):
        ...
        self.assertEqual(six.text_type(msg[1][4][1][1]), 'Repeat1')
        self.assertTrue(isinstance(msg[1][4][1][1], six.text_type))
        self.assertEqual(six.text_type(msg[1][4][2][1]), 'Repeat2')
        self.assertTrue(isinstance(msg[1][4][2][1], six.text_type))
    ...
    def test_file(self):
        ...
        self.assertEqual([s[0][1] for s in msg], ['MSH', 'EVN', 'PID', 'PD1', 'NK1', 'PV1'])
